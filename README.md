...
O código atual salva o estado completo da imagem após cada edição, consumindo muita memória, ou não implementa undo de forma adequada violando encapsulamento.
